...
#define RT64_UPSCALER_MODE_QUALITY				0x1
#define RT64_UPSCALER_MODE_BALANCED				0x2
#define RT64_UPSCALER_MODE_PERFORMANCE			0x3
#define RT64_UPSCALER_MODE_ULTRA_PERFORMANCE	0x4
