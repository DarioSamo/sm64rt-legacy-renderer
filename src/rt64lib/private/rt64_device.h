...
namespace RT64 {
	...
	private:
		...
		ID3D12RootSignature *d3dDebugMotionVectorsRootSignature;
		ID3D12PipelineState *d3dDebugMotionVectorsPipelineState;
	...
	public:
		...
		ID3D12RootSignature *getDebugMotionVectorsRootSignature() const;
		ID3D12PipelineState *getDebugMotionVectorsPipelineState() const;
