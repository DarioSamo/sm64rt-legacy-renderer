...
void RT64::Inspector::renderViewParams(View *view) {
    ...
    ImGui::Combo("Visualization Mode", &visualizationMode, "Normal\0Light only\0Motion vectors\0Shading position\0Shading normal\0Shading specular\0Color\0Instance ID\0Direct light\0Indirect light\0Reflection\0Refraction\0");
